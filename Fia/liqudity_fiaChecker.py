# -*- coding: utf-8 -*-
"""
Created on Wed Jan  5 03:40:16 2022
...
import time
private="" #wallet private key
api = '' #bscan api
sender_address = '' #wallet
busd = '0x55d398326f99059ff775485246999027b3197955'
bnb = '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c'
fia = '0x3489bE00546e660b58d182Bab7720de5aACb00F6'
busd_ad = '0x96eDEe13ECB5328B16D9D435059243eBa15Af5e8'
bnb_ad = '0x89c49956CAcC29c2A475bff500d29977ABE74774'
url1 = f'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress={busd}&address={busd_ad}&tag=latest&apikey={api}'
url2 = f'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress={bnb}&address={bnb_ad}&tag=latest&apikey={api}'
url3 = f'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress={fia}&address={busd_ad}&tag=latest&apikey={api}'
url4 = f'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress={fia}&address={bnb_ad}&tag=latest&apikey={api}'
####################################
...
spend1 = web3.toChecksumAddress("0x55d398326f99059fF775485246999027B3197955")  #BUSD Address (SWAP TO)
spend2 = web3.toChecksumAddress("0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c")  #BNB
...
tokenValue = web3.toWei(2355, 'ether')
print(tokenValue)
#Swaping exact Token for ETH 
#min_ToRecieve = web3.toWei(3, 'ether')

while(True):
    response1 = requests.get(url1)
    pages1 = json.loads(response1.text)
    response2 = requests.get(url2)
    pages2 = json.loads(response2.text)
# =============================================================================
#     response3 = requests.get(url3)
#     pages3 = json.loads(response3.text)
#     response4 = requests.get(url4)
#     pages4 = json.loads(response4.text)
# =============================================================================
    if response1.status_code != 200 or response2.status_code != 200:
        print('something goes wrong')
    if int(pages1['result']) > 21804405853115053706000: #20000$
    ...
    if int(pages2['result']) > 40700428040063901800: #40bnb
